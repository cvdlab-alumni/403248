...
corpoVolante=MAP(torus(7,1))(quadDomain(2*PI, 64))

p1=[[7,0,0.5],[0,1,0.5],[-1,3,0],[-1,0,0]]
p2=[[6.5,-2,0.5],[1,-7,0.5],[-8,8,0],[3,-8,0]]

p5=[[0,1,0.5],[0,-7,0.5],[0,0,0],[0,0,0]]
p6=[[0,1,0],[0,-7,0],[0,0,0],[0,0,0]]

p3=[[7,0,0],[0,1,0],[-1,3,0],[-1,0,0]]
p4=[[6.5,-2,0],[1,-7,0],[-8,8,0],[3,-8,0]]

p7=[[7,2,1],[5,5,1],[-3,0,0],[0,3,0]]
p8=[[7,2,-1],[5,5,-1],[-3,0,0],[0,3,0]]

volanteInterno1=supHermite(p1,p2,[0,0,0],[0,0,0])
volanteInterno2=supHermite(p3,p4,[0,0,0],[0,0,0])
volanteInterno3=supHermite(p1,p3,[0,0,0],[0,0,0])
volanteInterno4=supHermite(p2,p4,[0,0,0],[0,0,0])
volanteInterno5=supHermite(p5,p6,[0,0,0],[0,0,0])
volanteInterno6=supHermite(p6,p4,[0,0,0],[0,0,0])
volanteInterno7=supHermite(p5,p2,[0,0,0],[0,0,0])
volanteInterno8=supHermite(p7,p8,[-6,0,0],[6,0,0])

volanteInterno1=STRUCT([volanteInterno1,volanteInterno2,volanteInterno3,volanteInterno4,volanteInterno5,
                volanteInterno6,volanteInterno7])
volanteInterno2=T(3)(0.5)(R([1,3])(PI)(volanteInterno1))

logo=COLOR(YELLOW)(pieceOfCircle(2*PI,0,1))
volante=COLOR(BLACK)(STRUCT([volanteInterno1,volanteInterno2,corpoVolante,R([1,3])(PI)(volanteInterno8),volanteInterno8]))
volanteLogo=STRUCT([volante,T([2,3])([-1,0.55])(logo)])
volantePos=T([1,2,3])([4,7.5,-12])(R([2,3])(PI/12)(R([1,3])(PI)(S([1,2,3])([0.15,0.15,0.15])(volanteLogo))))

exercise04=STRUCT([volantePos,exercise03])
...
ss1=[[11.2,8.4,0],[12.2,2.5,0],[-2,0,-2],[1,-1,2]]
ss2=[[18.5,8.2,0],[18.5,2.5,0],[2,0,-2],[-2,1,2]]

mm1=[[12,7,-0.7],[13,7,-0.7],[0,0,-1],[0,0,1]]
mm2=[[12,6.8,-0.7],[13,6.8,-0.7],[0,0,-1],[0,0,1]]

ll1=[[11.8,4,-0.65],[18.9,4,-0.7],[0,0,0],[0,0,0]]
ll2=[[11.8,3.8,-0.63],[18.9,3.8,-0.68],[0,0,0],[0,0,0]]

portiera=supHermite(ss1,ss2,[0,0,0],[0,0,0])
maniglia=supHermite(mm1,mm2,[0,0,0],[0,0,0])
riga=supHermite(ll1,ll2,[0,0,-0.1],[0,0,0.1])

sportello=COLOR(GRAY)(STRUCT([portiera,maniglia,riga]))
sportelloPos=S(2)(0.85)(T([1,2,3])([8,0,-30])(R([1,3])(PI/2)(sportello)))
exercise05=STRUCT([sportelloPos,exercise04])
VIEW(exercise05)
