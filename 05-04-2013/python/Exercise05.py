...
#the groups of windows are organized in a STRUCT
windows= STRUCT([windowNorth,windowEast,windowSouth])
...
#the groups of ramps are organized in a STRUCT
ramp= STRUCT([floor0,floor1,floor2,floor3,floor4,ramp1T,ramp2T,ramp3T])

#COLORING
redRamp=COLOR(RED)(ramp)
grayFloor= COLOR(GRAY)(floors)

building = STRUCT([pillars,grayFloor,walls,windows, redRamp])
VIEW(building)