...
depth = 2.66;
raiser = 2.55;
verts = [[0,0],[0,1.4+raiser],[depth,raiser],[depth,1.4+raiser]]
cells = [[0,1,2],[1,2,3]]
step2D = SIMPLICIAL_COMPLEX(verts)(cells)
step3D = MAP([S1,S3,S2])(EXTRUDE([10.25])(step2D))
stair1t = STRUCT(NN(10)([step3D,T([1,3])([depth,raiser])]))
stair1= T([1,2])([20.89,2.5+47.5+2.5])(stair1t)

//second type stairs
depth2 = 3.16;
raiser2 = 2.05;
verts2 = [[0,0],[0,1.4+raiser2],[depth2,raiser2],[depth2,1.4+raiser2]]
cells2 = [[0,1,2],[1,2,3]]
step2Db = SIMPLICIAL_COMPLEX(verts2)(cells2)
step3Db = MAP([S1,S3,S2])(EXTRUDE([10.25])(step2Db))
stair2t = STRUCT(NN(12)([step3Db,T([1,3])([depth2,raiser2])]))
stair2 = T([1,2,3])([10.5,2.5+47.5+2.5,25+1])(stair2t)
stair3t = STRUCT(NN(12)([step3Db,T([1,3])([depth2,raiser2])]))
stair3 = T([1,2,3])([57.07,2.5+47.5+2.5,25+1+24+1])(stair3t)
